...
Public Class StatisticsView : Inherits VazorView
    ...
    Public Sub New(spares As List(Of SpareParts), viewData As ViewDataDictionary)
        MyBase.New("Statistics", "Views\Accounts", "Business Statistics")
        Me.Spares = spares
    ...
    Public Shared Function CreateNew(spares As List(Of SpareParts), viewData As ViewDataDictionary) As String
        Return VazorViewMapper.Add(New StatisticsView(spares, viewData))
    End Function
End Class
