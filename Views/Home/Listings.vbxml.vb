...
Partial Public Class ListingsView
            ...
            <ul>
                                                   ...
                                                   <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                                                       ...
                                                       <div class="d-flex flex-column mt-4">
                                                           ...
                                                           <%= (Function() As XElement
                                                                    ...
                                                                    If Not String.IsNullOrWhiteSpace(Session.User) AndAlso (Session.Role = Session.Roles.SPARE_PARTS_DEALER Or Session.Role = Session.Roles.ADMIN) AndAlso (Session.User = spare.Username Or Session.Role = Session.Roles.ADMIN) Then
                                                                        Return <div class="mt4">
                                                                                   ...
                                                                                   <input class="btn btn-danger deleteListing" type="submit" value="Delete" style="width: 100%;"/>
                                                                               </div>
                                                                    Else Return Nothing
                                                                    End If
                                                                End Function)() %>
                ...
                <ul class="pagination">
                    <%= (Function() As XElement
                             ...
                             <li class="page-item">
                                 <a class="page-link" href=<%= RequestBuilder("/Listings?", ViewData!getStr, Page.PREV) %>>Previous</a>
                             </li>, Nothing)
                         End Function)() %>
                    ...
                    <%= (Iterator Function() As IEnumerable(Of XElement)
                             For Each p As Integer In Enumerable.Range(CInt(ViewData!from), CInt(ViewData!to))
                                 Yield <li class="page-item nums">
                                           <%= (Function()
                                                    Return If(p <> 0,
                                                    <a class="page-link" href=<%= RequestBuilder("/Listings?", ViewData!getStr, Page.ELSE, p) %>><%= p %></a>, Nothing)
                                                End Function)() %>
                                       </li>
                             Next p
                         End Function)() %>
                    ...
                    <%= (Function() As XElement
                             ...
                             <li class="page-item">
                                 <a class="page-link" href=<%= RequestBuilder("/Listings?", ViewData!getStr, Page.NEXT) %>>Next</a>
                             </li>, Nothing)
                         End Function)() %>
                </ul>
                <script>
