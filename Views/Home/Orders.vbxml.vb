            ...
            <ul>
                <div class="row">
                    ...
                    <div class="col-md-9" id="loaded">
                        <h2 fff=""> Browse My Orders</h2>
                        <p><%= ViewData!total_rows.ToString() %> order(s) found:</p>
                                     ...
                                     Yield <div class="col-md-9">
                                               ...
                                               WAS <span class="strike-text">KSh. <%= Format((spare.Price * 1.1), "#,#.00") %></span>
                                                       ...
                                                       <div class="d-flex flex-column mt-4">
                                                           ...
                                                           <form class="mt4" asp-action="DeleteOrder" method="post" onsubmit="return confirm('Do you really want to cancel your order?');">
                                                               <input type="hidden" value=<%= spare.ID %> name="id"/>
                                                               <input type="hidden" value=<%= spare.Username %> name="username"/>

                                                               <input class="btn btn-danger" type="submit" value="Cancel Order" style="width: 100%;"/>
                                                           </form>, Nothing)
                                                                End Function)() %>
                                                       </div>
                                                   </div>
                ...
                <ul class="pagination">
                    <%= (Function() As XElement
                             ...
                             <li class="page-item">
                                 <a class="page-link" href=<%= RequestBuilder("/Orders?", ViewData!getStr, Page.PREV) %>>Previous</a>
                             </li>, Nothing)
                         End Function)() %>
                    ...
                    <%= (Iterator Function() As IEnumerable(Of XElement)
                             For Each p As Integer In Enumerable.Range(CInt(ViewData!from), CInt(ViewData!to))
                                 Yield <li class="page-item nums">
                                           <%= (Function()
                                                    Return If(p <> 0,
                                                    <a class="page-link" href=<%= RequestBuilder("/Orders?", ViewData!getStr, Page.ELSE, p) %>><%= p %></a>,
                                                    Nothing)
                                                End Function)() %>
                                       </li>
                             Next p
                    ...
                    <%= (Function() As XElement
                             ...
                             <li class="page-item">
                                 <a class="page-link" href=<%= RequestBuilder("/Orders?", ViewData!getStr, Page.NEXT) %>>Next</a>
                             </li>, Nothing)
                         End Function)() %>
                </ul>
            </ul>
