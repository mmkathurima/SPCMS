            ...
            <ul>
                <div class="row">
                    ...
                    <div class="col-md-9" id="loaded">
                        <h2 fff=""> Browse Shopping cart:</h2>
                                     ...
                                     Yield <div class="col-md-9">
                                               <div class="row p-2 border rounded">
                                                   <div class="col-md-3 mt-1">
                                                       <img class="img-fluid img-responsive rounded product-image" src=<%= spare.Uploads.Split(";"c)(0).Replace("\", "/") %>/>
                                                   </div>
                                                           ...
                                                           <%= (Function() As XElement
                                                                    ...
                                                                    <div class="mt4">
                                                                        <form asp-action="AddOrder" method="post">
                                                                            ...
                                                                            <input type="hidden" value=<%= spare.OrderQuantity %> name="quantity"/>
                                                                            <input type="hidden" value=<%= Session.User %> name="username"/>

                                                                            <input class="btn btn-success" type="submit" value="Order" style="width: 100%;"/>
                                                                        </form>

                                                                        <form asp-action="DeleteCart" method="post" onsubmit="return confirm('Do you really want to delete this item from your cart?');">
                                                                            <input type="hidden" value=<%= spare.ID %> name="id"/>
                        ...
                        <%= (Function() As XElement
                                 Return If(Not String.IsNullOrWhiteSpace(Session.User) AndAlso (Session.Role = Session.Roles.CONSUMER Or Session.Role = Session.Roles.ADMIN) AndAlso Spares.Any(), <a class="btn btn-primary" asp-controller="Home" asp-action="Checkout" style="width: 100%; margin-bottom: 10px;">Checkout</a>, Nothing)
                             End Function)() %>
                ...
                <ul class="pagination">
                    <%= (Function() As XElement
                             ...
                             <li class="page-item">
                                 <a class="page-link" href=<%= RequestBuilder("/Cart?", ViewData!getStr, Page.PREV) %>>Previous</a>
                             </li>, Nothing)
                         End Function)() %>
                    ...
                    <%= (Iterator Function() As IEnumerable(Of XElement)
                             For Each p As Integer In Enumerable.Range(CInt(ViewData!from), CInt(ViewData!to))
                                 Yield <li class="page-item nums">
                                           <%= (Function()
                                                    Return If(p <> 0,
                                                    <a class="page-link" href=<%= RequestBuilder("/Cart?", ViewData!getStr, Page.ELSE, p) %>><%= p %></a>,
                                                    Nothing)
                                                End Function)() %>
                                       </li>
                             Next p
                    ...
                    <%= (Function() As XElement
                             ...
                             <li class="page-item">
                                 <a class="page-link" href=<%= RequestBuilder("/Cart?", ViewData!getStr, Page.NEXT) %>>Next</a>
                             </li>, Nothing)
                         End Function)() %>
                </ul>
            </ul>
